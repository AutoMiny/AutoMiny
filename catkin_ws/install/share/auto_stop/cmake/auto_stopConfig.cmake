...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'auto_stop' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/model_car/catkin_ws/install/${idir}'.  Ask the maintainer 'strodl <strodl@todo.todo>' to fix it.")
    endif()
