...
if("TRUE" STREQUAL "TRUE")
  ...
  set(light_DEVEL_PREFIX /root/catkin_ws/odroid-devel/.private/light)
  set(light_INSTALL_PREFIX "")
  set(light_PREFIX ${light_DEVEL_PREFIX})
else()
  set(light_SOURCE_PREFIX "")
  set(light_DEVEL_PREFIX "")
  set(light_INSTALL_PREFIX /root/catkin_ws/odroid-install)
...
if(NOT "/root/catkin_ws/src/light/include " STREQUAL " ")
  set(light_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/src/light/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'light' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/light/${idir}'.  Ask the maintainer 'zargol <zahra.boroujeni@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/odroid-devel/.private/light/lib;/root/catkin_ws/odroid-devel/lib;/opt/odroid-x2/sdk/opt/ros/indigo/lib;/opt/odroid-x2/sdk//opt/ros/indigo/lib)
