...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/mi/boroujeni/model_car/catkin_ws/src/control)
  set(control_DEVEL_PREFIX /home/mi/boroujeni/model_car/catkin_ws/odroid-devel/.private/control)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/mi/boroujeni/model_car/catkin_ws/odroid-install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'zargol <zahra.boroujeni@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mi/boroujeni/model_car/catkin_ws/src/control/${idir}'.  Ask the maintainer 'zargol <zahra.boroujeni@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mi/boroujeni/model_car/catkin_ws/odroid-devel/.private/control/lib;/home/mi/boroujeni/model_car/catkin_ws/odroid-devel/lib;/opt/odroid-x2/sdk/opt/ros/indigo/lib;/opt/odroid-x2/sdk//opt/ros/indigo/lib)
