...
(cl:defmethod cl:initialize-instance :after ((m <Transform>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Transform)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fake_gps-msg:<Transform> is deprecated: use fake_gps-msg:Transform instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Transform>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fake_gps-msg:header-val is deprecated.  Use fake_gps-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'Transf-val :lambda-list '(m))
(cl:defmethod Transf-val ((m <Transform>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fake_gps-msg:Transf-val is deprecated.  Use fake_gps-msg:Transf instead.")
  (Transf m))
