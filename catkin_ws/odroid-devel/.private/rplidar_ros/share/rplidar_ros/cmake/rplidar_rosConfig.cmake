...
if("TRUE" STREQUAL "TRUE")
  set(rplidar_ros_SOURCE_PREFIX /root/catkin_ws/src/rplidar_ros)
  set(rplidar_ros_DEVEL_PREFIX /root/catkin_ws/odroid-devel/.private/rplidar_ros)
  ...
  set(rplidar_ros_INSTALL_PREFIX /root/catkin_ws/odroid-install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rplidar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/rplidar_ros/${idir}'.  Ask the maintainer 'Ling <mickey.leen@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/odroid-devel/.private/rplidar_ros/lib;/root/catkin_ws/odroid-devel/lib;/opt/odroid-x2/sdk/opt/ros/indigo/lib;/opt/odroid-x2/sdk//opt/ros/indigo/lib)
