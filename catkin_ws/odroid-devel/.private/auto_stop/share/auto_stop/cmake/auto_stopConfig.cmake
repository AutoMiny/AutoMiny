...
if("TRUE" STREQUAL "TRUE")
  set(auto_stop_SOURCE_PREFIX /home/mi/boroujeni/model_car/catkin_ws/src/auto_stop)
  set(auto_stop_DEVEL_PREFIX /home/mi/boroujeni/model_car/catkin_ws/odroid-devel/.private/auto_stop)
  ...
  set(auto_stop_INSTALL_PREFIX /home/mi/boroujeni/model_car/catkin_ws/odroid-install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'auto_stop' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mi/boroujeni/model_car/catkin_ws/src/auto_stop/${idir}'.  Ask the maintainer 'strodl <strodl@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mi/boroujeni/model_car/catkin_ws/odroid-devel/.private/auto_stop/lib;/home/mi/boroujeni/model_car/catkin_ws/odroid-devel/lib;/opt/odroid-x2/sdk/opt/ros/indigo/lib;/opt/odroid-x2/sdk//opt/ros/indigo/lib)
