...
def is_emergency_stop_necessary(break_distance, forward_minimum_distance, index, ranges):
...
def first_forward_emergency_stop_evaluation(angle_front, angle_increment, break_distance,
    ...
    while emergency_stop_does_not_need_to_happen:
        ...
        necessary = is_emergency_stop_necessary(break_distance, forward_minimum_distance, index, ranges)
