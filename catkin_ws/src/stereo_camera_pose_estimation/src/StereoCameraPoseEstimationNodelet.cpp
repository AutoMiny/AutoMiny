...
namespace stereo_camera_pose_estimation {
    ...
    public:
        ...
        void onInit() override {
            ...
            planeCloudPublisher = pnh.advertise<sensor_msgs::PointCloud2>("plane_pcl", 10);
            ...
            infraImageSubscriber.subscribe(it, "camera/color/image_rect_color", 2);
            depthImageSubscriber.subscribe(it, "camera/depth/image_rect_raw", 2);
            infraCameraInfoSubscriber.subscribe(pnh, "camera/color/camera_info", 2);
    ...
    private:
        ...
        ros::Publisher markerImagePublisher;
