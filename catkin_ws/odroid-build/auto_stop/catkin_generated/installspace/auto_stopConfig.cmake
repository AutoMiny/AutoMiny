...
if("FALSE" STREQUAL "TRUE")
  ...
  set(auto_stop_DEVEL_PREFIX /root/catkin_ws/odroid-devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'auto_stop' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/odroid-install/${idir}'.  Ask the maintainer 'strodl <strodl@todo.todo>' to fix it.")
    endif()
